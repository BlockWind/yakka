## 代码管理
### 分支说明
- main分支：公共代码库，用于main-enterprise分支和main-personal分支之间共享、同步、合并代码。例如main-enterprise分支提交的公共功能组件，或者命名以及代码完全相同的业务功能文件，main-personal分支合并后，稍作适配修改即可使用
- main-enterprise = 企业版代码分支。基础功能和个人版代码相同，但是支持后端server，属于CS架构。
- main-personal = 个人版代码分支。基础功能和企业版代码相同，但是只支持局域网通信，无后端server。
